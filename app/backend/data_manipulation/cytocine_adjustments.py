...
def adjust_cytokine(parameters):
    parameters.do_recalculate = parameters.recalculate_modules or \
            not os.path.exists(os.path.join(parameters.path_files, 'cyto_mod_adj.dill'))
    ...
    if parameters.do_recalculate:
        ...
        parameters.cyto_mod_abs = tools.read_from_dill(os.path.join(parameters.path_files, 'cyto_mod_abs.dill'))
        parameters.cyto_mod_adj = tools.read_from_dill(os.path.join(parameters.path_files, 'cyto_mod_adj.dill'))
