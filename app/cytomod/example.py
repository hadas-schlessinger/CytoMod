...
colInds = app.cytomod.plotting.plotHierClust(1 - rcyc.pwrel,
                                             rcyc.Z,
                                             labels=rcyc.labels,
...
app.cytomod.plotting.plotModuleEmbedding(rcyc.dmatDf, rcyc.labels, method='kpca', txtSize='large')
